# ASTR 472 Problem Set 07 Assessment Instructions
...
- Problem 1 (Inner-Galaxy kinematics): verify the governing relation, units, and stated validity domain.
- Problem 2 (Completeness-corrected density): recompute the central value and uncertainty independently; check comparison direction.
- Problem 3 (Comparative survey claim): require the requested alternative-model, uncertainty, or synthesis discussion, not a generic paragraph.
