# ASTR 472 Problem Set 02 Assessment Instructions
...
- Problem 1 (Noise scaling): verify the governing relation, units, and stated validity domain.
- Problem 2 (Brightness temperature): recompute the central value and uncertainty independently; check comparison direction.
- Problem 3 (Thermal versus systematic floor): require the requested alternative-model, uncertainty, or synthesis discussion, not a generic paragraph.
