# Assessment Instructions: Problem Set 02 — Plate Scale and Nyquist Sampling for a New Instrument
...
- Problem 1: 20 points.
- Problem 2: 15 points.
- Problem 3: 15 points — correct Nyquist classification.
- Problem 4: 20 points — correct, numerically supported design fix.
...
- Forgetting to convert pixel size from micrometers to millimeters before multiplying by plate scale.
- Comparing pixel scale to the full FWHM instead of half the FWHM (the actual Nyquist criterion).
